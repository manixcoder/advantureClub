         ...
         <div class="row">
            <div class="col-md-6">
               <ul>
                  ...
                  <li>
                     ...
                     <h3 class="ellipsis"><?php foreach($healthConditionData as $val){ if(count($healthConditionData)>1){?><span>{{$val->name .', '}}</span> <?php }else{?><span>{{$val->name}}</span><?php }}?></h3>
                  </li>
                  <li>
                     <p>Weight in Kg :</p>
            ...
            <div class="col-md-6">
               <ul>
                  ...
                  <li>
                     <p>Partnership :</p>
                     <h3><?php foreach($subscriptionData as $val){echo $val->duration;}?></h3>
                  </li>
                  <li>
                     <p>Payment :</p>
                  ...
                  <li>
                     <p>Payment Setup :</p>
                     <h3 class="ellipsis"><?php foreach($pModeData as $val){ if(count($pModeData)>1){echo $val->payment_name.' , ';}else{echo $val->payment_name;}}?></h3>
                  </li>
               </ul>
            </div>
         </div>
