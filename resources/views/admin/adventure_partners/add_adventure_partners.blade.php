                  ...
                  <div class="card-body">
                     <div class="row">     
                        ...
                        <!--<div class="col-md-12">
                           <div class="form-group search_part">  
                              <input type="text" id="UserName1" name="search" class="form-control" aria-required="true" placeholder="Search by user id,name,email,mobile...." >
                        ...
                        <div class="col-md-6">
                           <div class="form-group date_of_birth">  
                              ...
                              <?php } ?>
                              <!-- <input type="text" onfocus="(this.type='date')"onblur="(this.value == '' ? this.type='text' : this.type='date')" id="date_of_birth" name="date_of_birth" class="form-control" aria-required="true" placeholder="Date of Birth">  -->
                              <!-- <span><img src="{{URL::to('/public/images/calender.png')}}"></span> -->
                           </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6 ">
                           <div class="form-group"> 
                              ...
                              <!-- <label for="file-input">
                                 <img src="{{URL::to('/public/images/attach.png')}}" style="pointer-events: none"/>
                              </label>
                              <input  type="file" id="image" name="image" aria-required="true" accept="image/*">  --> 
                        ...
                        <?php
                          ...
                          <div class="col-md-3">
                              <div class="form-group">  
                                 <input type="checkbox" id="chk_{{$value->id}}" value="{{$value->id}}" <?php if(request('health_condition') && in_array($value->id,$health_condition)){ echo 'checked';}?> name="health_condition[]">
                        ...
                        <div class="col-md-12">
                           <div class="form-group">
                              <div class="radio radio-info form-check-inline license_status_yes">
                                 <input type="radio" id="yes" value="1" name="license_status" <?php if(request('license_status') == '' || request('license_status') == '1'){ echo 'checked';}?>>
                                 <label for="inlineRadio2"> Yes </label>
                              </div>
                              <div class="radio radio-info form-check-inline license_status_no">
                                 <input type="radio" id="no" value="0" name="license_status" <?php if(request('license_status') == '0'){ echo 'checked';}?>>
                     ...
                     <!-- <div class="attach_cr">
                        ...
                        <?php
                          ...
                          <div class="col-md-3">
                              <div class="form-group">  
                                 <input type="checkbox" id="chk_{{$value->id}}" value="{{$value->id}}" <?php if(request('payment_mode') && in_array($value->id,$payment_mode)){ echo 'checked';}?> name="payment_mode[]">
                        ...
                        <div class="form-group">  
                           ...
                           <?php 
                                 ...
                                 foreach($subscription as $value){
                                    ...
                                    if($value->id == '2'){$active = 'active';}else{$active='';}
                                    if($value->id == '3'){$active = 'active';}else{$active='';}
                                    if($value->id == '4'){$active = 'active';}else{$active='';}
                                    if ($value->id == '1') {$active = 'active';}else{$active='';}
                           ?>
                                 <li>
                                    <span class="form-group plan {{$active}}" 
                                       id="subscription_{{$value->id}}" name="subscription" value="{{$value->id}}">
