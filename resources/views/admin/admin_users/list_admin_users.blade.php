                  ...
                  <table id="datatable-responsive1" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                     ...
                     <tbody>
                        ...
                        <tr class="gradeX">
                           ...
                           <td>{{ $data->mobile }}</td>
                           <td>{{ $data->country}}</td>
                           <td><?php if($data->users_role=='1'){ echo 'Admin';}else{ echo 'users'; } ?></td>
                           ...
                           <td class="actions"> 
                             ...
                             <a href="{{URL::to('view-admin-user',$data->id)}}" class="waves-effect" data-toggle="tooltip" data-placement="top" title="" data-original-title="View"><img src="{{ asset('/public/images/ac_view.png')}}"></a>
                              &nbsp;&nbsp;&nbsp;
