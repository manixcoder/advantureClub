...
class PromocodeController extends Controller
{
    public function __construct() {
      ...
      public function add_promocode(Request $request){  //echo"<pre>";print_r($request->all());exit;
        
        if ($request->post()) {
           
          $rules =  ['promocode_name'  => 'required|min:4|max:12|unique:promocode,promocode_name' . ($request->edit_id ? ",$request->edit_id" : ''),
