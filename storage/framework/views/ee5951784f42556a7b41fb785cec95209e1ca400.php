<div class="content add_adventure_users">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h4 class="pull-left page-title"><a href="<?php echo e(URL::to('privacy-policy')); ?>" >Privacy Policy</a> > Edit</h4>
            </div>
        </div>

        <form  action="<?php echo e(URL::to('privacy-policy/add')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="row">
...
</script><?php /**PATH /home/advent12/public_html/admin/resources/views/admin/pages/update_privacy_policies.blade.php ENDPATH**/ ?>