...
<div class="content add_adventure_users">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h4 class="pull-left page-title"><a href="<?php echo e(URL::to('countries')); ?>" >Locations </a> > Create Country</h4>
            </div>
        </div>
        <form  action="<?php echo e(URL::to('countries/add')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                                ...
                                <div class="col-md-6">         
                                    <div class="form-group"> 
                                        ...
                                        <?php if (isset($validation['short_name'])) { ?>
                                            <label class="error"><?php echo e($validation['short_name']); ?></label>
                                        <?php } ?>
                                    </div>
                                </div>
                                <div class="col-md-6">         
                                ...
                                <div class="col-md-6">         
                                    <div class="form-group"> 
                                        ...
                                        <?php if (isset($validation['flag'])) { ?>
                                            <label class="error"><?php echo e($validation['flag']); ?></label>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
...
<?php /**PATH /home/advent12/public_html/admin/resources/views/admin/locations/add_country.blade.php ENDPATH**/ ?>