            ...
            <div class="card ">
               <div class="card-body">
                  <table id="datatable-responsive1" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                     ...
                     <tbody>
                        <?php $__currentLoopData = $reviewdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <!-- echo"<pre>";<?php echo e(print_r($data)); ?>;exit;  -->
                        <tr class="gradeX">
                           <td>#<?php echo e($data->id); ?> - <br /> <?php echo e($data->adventure_name); ?></td>
                              ...
                              <ul class="edit_icon action_icons dashboard_icons">
                                 <li>
                                    <!-- <a href="" class="waves-effect" data-toggle="tooltip" data-placement="top" title="" data-original-title="reply">
                                       <img src="<?php echo e(asset('/public/images/reply.png')); ?>">
                                    </a> -->
                                    <button id="myBtn"><img src="<?php echo e(asset('/public/images/reply.png')); ?>"></button>
                                    <!-- <a href="<?php echo e(URL::to('view-adventure-user',$data->id)); ?>" class="waves-effect" data-toggle="tooltip" data-placement="top" title="" data-original-title="reply"><img src="<?php echo e(asset('/public/images/reply.png')); ?>"></a> -->
                                 </li>
                                 <li>
                                    <?php ?>
                                    <a href="#" class="like-Unlike" id="like_<?php echo $data->id; ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="like">
                                       <img src="<?php echo e(asset('/public/images/unlike.png')); ?>">
                                    </a>
                                 ...
                                 <li>
                                    ...
                                    <a href="#" class="block_<?php echo $status; ?>" id="status" class="waves-effect" data-toggle="tooltip" data-placement="top" title="" data-original-title="block"><img src="<?php echo e(URL::to($img)); ?>"></a>
                                 </li>
                                 <!-- <a href="<?php echo e(URL::to('add-adventure-user',$data->id)); ?>" class="on-default edit-row"data-toggle="tooltip" data-modal="modal-12" data-placement="top" title="" data-original-title="Edit"><i class="fas fa-pencil-alt"></i></a> 
                              &nbsp;&nbsp;&nbsp; -->

                                 <!-- <a href="<?php echo e(URL::to('delete-customer',$data->id)); ?>" class="on-default remove-row" onclick="return confirm('Are you sure you want to delete this item?');" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="fas fa-trash"></i></a> -->
                                 ...
                                 <form action="#" method="POST" id="FormValidation" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-footer text-center">
                                       <button type="cancel" id="canceltbtn" class="btn btn-default cancel">
                                          <a href="<?php echo e(url()->previous()); ?>">Cancel</a></button>
...
<script type="text/javascript">
   $(document).ready(function() {
      ...
      $('#status').click(function() {
         ...
         $.ajax({
            url: "<?php echo e(url('update-review-status')); ?>" + '/' + id,
            method: "GET",
      ...
      $(".like-Unlike").click(function(e) {
         ...
         $.ajax({
            url: "<?php echo e(url('update-like-status')); ?>" + '/' + id,
            method: "GET",
            data: {
               "id": id,
               "status": changedText
...
</script><?php /**PATH /home/advent12/public_html/admin/resources/views/admin/services/list_reviews.blade.php ENDPATH**/ ?>