...
<?php
$userprofile = DB::table('users')->where('id', Session::get('gorgID'))->first();
?>
<!DOCTYPE html>
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <!-- Fontawasom -->
        <link href="<?php echo e(asset('public/assets/fontawesome/css/all.min.css')); ?>" rel="stylesheet">
        <!-- Plugins css -->
        ...
        <!--calendar css-->
        <link href="<?php echo e(asset('public/assets/plugins/fullcalendar/dist/fullcalendar.css')); ?>" rel="stylesheet">
        <link href="<?php echo e(asset('public/assets/plugins/select2/dist/css/select2.css')); ?>" rel="stylesheet" type="text/css">
        <!-- Custom Files -->
        ...
        <link href="<?php echo e(asset('public/assets/css/developer.css')); ?>" rel="stylesheet" type="text/css" />

        <!-- Alert -->
        <script src="https://code.jquery.com/jquery-3.3.1.min.js"></script>
        <script src="https://cdn.jsdelivr.net/npm/gijgo@1.9.10/js/gijgo.min.js" type="text/javascript"></script>
        <script src="<?php echo e(asset('public/assets/js/calendar.js')); ?>"></script>
    ...
    <body class="fixed-left">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="<?php echo e(URL::to('dashboard')); ?>" class="logo"><img src="<?php echo e(asset('public/images/logo_header.png')); ?>"></a>
                    </div>
                </div>
                        ...
                        <ul class="nav navbar-right float-right list-inline">
                            ...
                            <li class="dropdown open">
                                <a href="#" class="dropdown-toggle profile" data-toggle="dropdown" aria-expanded="true">
                                    ...
                                    ?>
                                    <img src="<?php echo e($profile_img); ?>" alt="profilepic" class="rounded-circle">

                                    <span><?php echo e($userprofile->name); ?><i class="fa fa-angle-down"></i></span>
                                </a>
        ...
        document.getElementById('logout-form').submit();" class="dropdown-item"><i class="md md-settings-power mr-2"></i> <?php echo e(__('Logout')); ?></a></li>
            ...
            <?php endif; ?><?php /**PATH /home/arknewtech/public_html/adventuresClub/resources/views/layouts/header.blade.php ENDPATH**/ ?>