                    ...
                    <tbody>
                        ...
                        ?>
                                <tr class="gradeX">
                                    ...
                                    <td><?php echo e($pkg->symbol); ?><?php echo e(abs($pkg->cost)); ?></td>
                                    <td><?php echo e($pkg->symbol); ?><?php echo e(abs($pkg->offer_cost)); ?></td>
                                    <?php
                                    if ($pkg->status == 1) {
                                        $status = 'Active';
                                        $class = 'badge-success';
                                    ...
                                    <td>
                                        <p class="mb-0">
                                            <span id="statusText_<?php echo e($pkg->id); ?>" class="badge <?php echo $class; ?>"><?php echo e($status); ?></span>
                                        </p>
                                    </td>
                                    <td>
                                        <ul class="edit_icon action_icons dashboard_icons">
                                            <li>
                                                <label class="switch">
                                                    ...
                                                    ?>
                                                    <input type="checkbox" class="togBtn" id="togBtn_<?php echo e($pkg->id); ?>" name="togBtn_<?php echo e($pkg->id); ?>" value="<?php echo e($statVal); ?>" <?php echo $checked; ?> />
                                                    <span class="slider round"></span>
                                                </label>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(URL::to('sub-packages/delete/'.$pkg->id)); ?>" onclick="return confirm('Are you sure you want to delete this request ?')" class="bg-red"><i class="fa fa-trash"></i></a>
                                            </li>
                                        </ul>
                                    </td>
                                </tr>
...
<script>
    $(window).load(function() {
        $('#datatable-responsive1').on("click", ".togBtn", function() {
            ...
            $.ajax({
                url: "<?php echo e(url('update-pkg-status')); ?>" + '/' + id,
                method: "GET",
...
</script><?php /**PATH /home/advent12/public_html/admin/resources/views/admin/pages/packages.blade.php ENDPATH**/ ?>