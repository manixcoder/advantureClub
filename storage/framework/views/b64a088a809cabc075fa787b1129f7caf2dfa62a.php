...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h4 class="pull-left page-title"><a href="<?php echo e(URL::to('list-adventure-users')); ?>">Users </a> > #<?php echo e($editdata->id); ?></h4>
            </div>
        </div>
        <?php
        // dd($editdata);
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <ul>
                                <li>
                                    <p>User ID :</p>
                                    <h3><?php echo e($editdata->id); ?></h3>
                                </li>
                                <li>
                                    <p>User Name :</p>
                                    <h3><?php echo e($editdata->name); ?></h3>
                                </li>
                                <li>
                                    <p>Email Address :</p>
                                    <h3><?php echo e($editdata->email); ?></h3>
                                </li>
                                <li>
                                    <p>Mobile No. :</p>
                                    <h3><?php echo e($editdata->mobile_code); ?> - <?php echo e($editdata->mobile); ?></h3>
                                </li>
                                <li>
                                    <p>Nationality :</p>
                                    <h3><?php echo e($editdata->short_name); ?></h3>
                                </li>
                                <li>
                                    <p>Country :</p>
                                ...
                                <li>
                                    <p>City/State :</p>
                                    <h3><?php echo e($editdata->region); ?></h3>
                                </li>
                                <li>
                                    <p>Date of Birth :</p>
                                ...
                                <li>
                                    ...
                                    <?php else: ?>
                                    <img src="<?php echo e(asset('public/images/avatar-5.png')); ?>" alt="image" width="100" height="100">
                                    <?php endif; ?>
                        ...
                        <div class="col-md-6">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <h3><?php echo e($editdata->bookingscount); ?>  Activity</h3>
                                </li>
                                <li>
                                    <p>Status :</p>
                                    <h3>
                                ...
                                <li>
                                    <div id="cometchat" class="cometchat">
                                        <img src="<?php echo e(asset('/public/images/button_notify.png')); ?>">
                                        Notify
                                    </div>
                                    <?php
                                   ...
                                   ?>
                                    ...
                                    <a href="<?php echo e($url); ?>" id="delete" class="delete">
                                        <img src="<?php echo e(asset('/public/images/button_notify.png')); ?>">
                                        Delete
                                    </a>
                                ...
                                <div id="myModal" class="modal">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="users_data">
                                            <div>Name : <?php echo e($editdata->name); ?></div>
                                            <div>Name : <?php if($editdata->profile_image!=''): ?>
                                                <img src="<?php echo e(asset('public/').'/'.$editdata->profile_image); ?>" alt="image" width="100" height="100">
                                                <?php else: ?>
                                                <img src="<?php echo e(asset('public/images/avatar-5.png')); ?>" alt="image" width="100" height="100">
                                                <?php endif; ?>
                                        ...
                                        <div><?php echo e($editdata->mobile_code); ?> - <?php echo e($editdata->mobile); ?></div>
                                        <div><?php echo e($editdata->email); ?></div>
                                        <form action="<?php echo e(URL::to('notify-user')); ?>" method="POST" id="FormValidation" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <input type="hidden" name="user_id" value="<?php echo e($editdata->id); ?>">
...
</script><?php /**PATH /home/advent12/public_html/admin/resources/views/admin/adventure_users/view_adventure_user.blade.php ENDPATH**/ ?>