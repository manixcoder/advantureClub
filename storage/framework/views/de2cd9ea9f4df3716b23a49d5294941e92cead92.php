...
<div class="content add_adventure_users">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h4 class="pull-left page-title"><a href="<?php echo e(URL::to('list-service-offers')); ?>">Service Offers</a> > Create Service Offer</h4>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <div class="row">  
                                ...
                                <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="adventure_name" name="adventure_name"  >
                                                ...
                                                foreach ($adv_names as $value) {
                                                    ...
                                                    ?>
                                                    <option value="<?php echo e($value->id); ?>" <?php echo $sel; ?>><?php echo e($value->adventure_name); ?></option>
                                                <?php } ?>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">  
                                            ...
                                            ?>
                                            <input type="text" id="name" name="name" class="form-control" value="<?php echo e($name); ?>" aria-required="true" placeholder="Offer Name"> 
                                ...
                                <div class="form-group date_of_birth">  
                                    ...
                                    ?>
                                    <input type="date" id="start_date" name="start_date" class="form-control"  aria-required="true" placeholder="Start Date" value="<?php echo e($start_date); ?>" > 
                                ...
                                <?php
                                    ...
                                    ?>
                                    <input type="date"  id="end_date" name="end_date" class="form-control"  aria-required="true" placeholder="End Date" value="<?php echo e($end_date); ?>" > 
                                   <!--  <span><img src="<?php echo e(URL::to('/public/images/calender.png')); ?>" id="datepicker" ></span>  -->
                                    ...
                                    <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="currency" name="currency">
                                                    ...
                                                    ?>
                                                        <option value="<?php echo e($value->currency); ?>" <?php echo $sel; ?>><?php echo e($value->currency.' - '.$value->country); ?></option>
                                                    <?php } ?>
                                                </select>
                                ...
                                <div class="col-md-6 license_status">
                                    <div class="form-group">
                                        ...
                                        <input  type="file" id="banner" name="banner" class="form-control" value="<?php echo e($banner_img); ?>" aria-required="true" accept="image/*"> 
                                        <?php if (isset($validation['banner'])) { ?>
                                            <label class="error"><?php echo e($validation['banner']); ?></label>
                                        <?php } ?>         
                                    </div>
                                </div>
                                ...
                                <?php
                                        ...
                                        ?>
                                    <textarea rows="5" name="description" class="form-control info" placeholder="Write description..." ><?php echo e($description); ?></textarea>
...
<?php /**PATH /home/advent12/public_html/admin/resources/views/admin/service_offers/add_service_offer.blade.php ENDPATH**/ ?>