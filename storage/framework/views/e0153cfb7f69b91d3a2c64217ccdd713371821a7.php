...
<body class="fixed-left">
    ...
    <div id="wrapper">
            ...
            <div class="topbar-left">
                <div class="text-center">
                    <a href="<?php echo e(URL::to('dashboard')); ?>" class="logo">
                        <img src="<?php echo e(asset('public/images/logo_header.png')); ?>">
                    </a>
                </div>
            </div>
        ...
        <?php endif; ?><?php /**PATH /home/advent12/public_html/admin/resources/views/layouts/header.blade.php ENDPATH**/ ?>