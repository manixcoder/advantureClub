        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <ul class="breadcrumb pull-right">
                    <li>
                        <a href="<?php echo e(URL::to('privacy-policy/add')); ?>" class="waves-effect">
...
</div><?php /**PATH /home/advent12/public_html/admin/resources/views/admin/pages/privacy_policy_list.blade.php ENDPATH**/ ?>