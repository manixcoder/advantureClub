                    ...
                    <tbody>
                        ...
                        if (count($result)) {
                            foreach ($result as $key => $res) {
                                ?>
                                <tr class = "gradeX">
                                    <td>#<?php echo e($res->transaction_id); ?></td>
                                    <td><?php echo e($res->name); ?></td>
                                    <td><?php echo e($res->transaction_id); ?></td>
                                    <td><?php echo e(date('d M, Y | h:i a', strtotime($res->created_at))); ?></td>
...
</div><?php /**PATH /home/advent12/public_html/admin/resources/views/admin/pages/transactions.blade.php ENDPATH**/ ?>