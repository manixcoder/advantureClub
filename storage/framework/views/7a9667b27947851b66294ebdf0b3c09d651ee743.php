                     ...
                     <tbody>
                        ...
                        <tr class="gradeX">
                           ...
                           <td class="actions">
                              ...
                              <a href="<?php echo e(URL::to('view-admin-user',$data->id)); ?>" class="waves-effect" data-toggle="tooltip" data-placement="top" title="" data-original-title="View"><img src="<?php echo e(asset('/public/images/ac_view.png')); ?>"></a>
                              &nbsp;&nbsp;&nbsp;

                              <a href="<?php echo e(URL::to('delete-adminuser',$data->id)); ?>">Delete</a> &nbsp;&nbsp;&nbsp;
                              ...
                              <!-- <a href="<?php echo e(URL::to('product-edit',$data->id)); ?>" class="on-default edit-row"data-toggle="tooltip" data-modal="modal-12" data-placement="top" title="" data-original-title="Edit"><i class="fas fa-pencil-alt"></i></a> 
                              &nbsp;&nbsp;&nbsp; -->
                              <!--<?php if($data->status == 1): ?>-->
                              <!-- <a href="<?php echo e(URL::to('delete-customer',array($data->id,$data->status))); ?>" class="waves-effect" data-toggle="tooltip" data-placement="top" title="" data-original-title="Status"><img src="<?php echo e(asset('/public/images/ac_active.png')); ?>"></a> -->
                              <!--<a href="#" class="waves-effect" data-toggle="tooltip" data-placement="top" title="" data-original-title="Status"><img src="<?php echo e(asset('/public/images/ac_active.png')); ?>"></a>-->
                              <!--<?php else: ?>-->
                              <!--   <a href="<?php echo e(URL::to('delete-customer',array($data->id,$data->status))); ?>" class="waves-effect" data-toggle="tooltip" data-placement="top" title="" data-original-title="Status"><img src="<?php echo e(asset('/public/images/ac_inactive.png')); ?>"></a>-->
                              <!--<?php endif; ?> -->
...
</script><?php /**PATH /home/advent12/public_html/admin/resources/views/admin/admin_users/list_admin_users.blade.php ENDPATH**/ ?>