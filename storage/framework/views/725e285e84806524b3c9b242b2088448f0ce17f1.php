      ...
      <div class="row">
         <div class="col-sm-12">
            ...
            <ul class="breadcrumb pull-right">
               <li><a href="<?php echo e(URL::to('add-announcement')); ?>" class="waves-effect"><img src="<?php echo e(asset('/public/images/add_user.png')); ?>">&nbsp;&nbsp;<span>Add Announcement</span></a>
            </ul>
         </div>
      </div>
      <div class="row">
            ...
            <div class="card ">
               <div class="card-body">
                  <table id="datatable-responsive1" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                     <thead>
                        <tr>
                           <th class="no-sort"> Announcement Id</th>
                           <th class="no-sort">Title</th>
                           <th class="no-sort">Reach for</th>
                     ...
                     <tbody>
                        ...
                        <tr class="gradeX">
                           ...
                           <td><?php echo e($data->reach_for); ?></td>
                           ...
                           <td class="actions"> 
                               ...
                               <a href="<?php echo e(URL::to('delete-announcement',$data->id)); ?>" >Delete</a> 
...
</script><?php /**PATH /home/advent12/public_html/admin/resources/views/admin/transactions/announcement.blade.php ENDPATH**/ ?>