...
<div class="content add_partner">
   <div class="container-fluid">
      <div class="row">
         <div class="col-sm-12">
            <h4 class="pull-left page-title"><a href="<?php echo e(URL::to('list-adventure-partners')); ?>">Partners</a> > Add New Partner</h4>
         </div>
      </div>
      <?php
      if (!empty($editData)) {
      ...
      <?php } ?>
      <form action="<?php echo e(URL::to('add-adventure-partner')); ?>" method="POST" id="FormValidation" enctype="multipart/form-data">
         <?php echo csrf_field(); ?>
                     ...
                     <div class="row">
                           ...
                           <div class="form-group">
                              ...
                              <select class="form-control" id="country" name="country">
                                 ...
                                 foreach ($countries as $value) { ?>
                                    <option value="<?php echo e($value->id); ?>" <?php echo e($country ==  $value->id  ? 'selected' : ''); ?>><?php echo e($value->country); ?></option>
                                 <?php } ?>
                              </select>
                        ...
                        <div class="col-md-6">
                           <div class="form-group date_of_birth">
                              ...
                              ?>
                              <input type="text" id="dob" name="dob" class="form-control" aria-required="true" placeholder="Date of Birth" value="<?php echo e($dob); ?>">
                              <span><img src="<?php echo e(URL::to('/public/images/calender.png')); ?>"></span>
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              ?>
                              <input type="text" id="weight" name="weight" class="form-control" aria-required="true" placeholder="Weight in KG" value="<?php echo e($weight); ?>">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              ?>
                              <input type="text" id="height" name="height" class="form-control" aria-required="true" placeholder="Height in CM" value="<?php echo e($height); ?>">
                        ...
                        <div class="col-md-6 ">
                           <div class="form-group">
                              ...
                              <input type="file" id="image" name="image" class="form-control" value="<?php echo e($image); ?>" aria-required="true" accept="image/*">
                        ...
                        ?>
                           <div class="col-md-3">
                              <div class="form-group">
                                 <input type="checkbox" id="chk_<?php echo e($value->id); ?>" value="<?php echo e($value->id); ?>" <?php if (request('health_condition') && in_array($value->id, $health_condition)) {
                                                                                                            echo 'checked';
                                                                                                         } ?> name="health_condition[]">
                                 <span for="chk_<?php echo e($value->id); ?>"> <?php echo e($value->name); ?> </span>
                              </div>
                           </div>
                        <?php } ?>
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              ?>
                              <input type="text" id="company_name" name="company_name" class="form-control" aria-required="true" placeholder="Company Name" value="<?php echo e($company_name); ?>">
                              <?php if (isset($validation['company_name'])) { ?>
                                 <label class="error"><?php echo e($validation['company_name']); ?></label>
                              <?php } ?>
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              ?>
                              <input type="text" id="company_address" name="company_address" class="form-control" aria-required="true" placeholder="Office Address" value="<?php echo e($company_address); ?>">
                              <?php if (isset($validation['company_address'])) { ?>
                                 <label class="error"><?php echo e($validation['company_address']); ?></label>
                              <?php } ?>
                           </div>
                        </div>
                        <div class="col-md-12">
                           <div class="form-group date_of_birth">
                              ...
                              <input type="text" id="company_location" name="company_location" class="form-control" aria-required="true" placeholder="Geo Location" value="<?php echo e($company_location); ?>">
                              <span onclick="getLocation()">
                                 <img src="<?php echo e(URL::to('/public/images/map.png')); ?>">
                              </span>
                              <?php if (isset($validation['company_location'])) { ?>
                                 <label class="error"><?php echo e($validation['company_location']); ?></label>
                              <?php } ?>
                           </div>
                        </div>
                        ...
                        <div class="col-md-6 license_status">
                           <div class="form-group">
                              ...
                              ?>
                              <input type="text" id="cr_name" name="crName" class="form-control" aria-required="true" placeholder="CR Name" value="<?php echo e($crName); ?>">
                              <?php if (isset($validation['crName'])) { ?>
                                 <label class="error"><?php echo e($validation['crName']); ?></label>
                              <?php } ?>
                           </div>
                        </div>
                        <div class="col-md-6 license_status">
                           <div class="form-group">
                              ...
                              ?>
                              <input type="number" id="cr_number" name="crNumber" class="form-control" aria-required="true" placeholder="CR Number" value="<?php echo e($crNumber); ?>">
                              <?php if (isset($validation['crNumber'])) { ?>
                                 <label class="error"><?php echo e($validation['crNumber']); ?></label>
                              <?php } ?>
                           </div>
                        </div>
                        <div class="col-md-6 license_status">
                           <div class="form-group">
                              ...
                              <input type="file" id="crCopy" name="crCopy" class="form-control" value="<?php echo e($crCopy); ?>" aria-required="true" accept="image/*">
                              <?php if (isset($validation['crCopy'])) { ?>
                                 <label class="error"><?php echo e($validation['crCopy']); ?></label>
                              <?php } ?>
                        ...
                        <div class="col-md-12">
                           ...
                           ?>
                              <div class="col-md-3">
                                 <div class="form-group">
                                    <input type="checkbox" id="chk_<?php echo e($value->id); ?>" value="<?php echo e($value->payment_name); ?>" <?php if (request('payment_mode') && in_array($value->id, $payment_mode)) {
                                                                                                                        echo 'checked';
                                                                                                                     } ?> name="payment_mode[]">
                                    <span for="chk_<?php echo e($value->id); ?>"> <?php echo e($value->payment_name); ?></span>
                                 </div>
                              </div>
                           <?php } ?>

                           <?php if (isset($validation['payment_mode'])) { ?>
                              <label class="error"><?php echo e($validation['payment_mode']); ?></label>
                           <?php } ?>
                        </div>
                        <div class="col-md-12 package_part" id="package_part">
                           <div class="form-group">
                              ...
                              <ul>
                                 ...
                                 ?>
                                    <li>
                                       <span class="form-group plan <?php echo e($active); ?>" id="subscription_<?php echo e($value->id); ?>" name="subscription" value="<?php echo e($value->id); ?>">
                                          <?php echo e($value->title); ?> - <?php echo e($value->duration); ?> <br />
                                          <em style="color:red">Today's offer:</em> <br />
                                          <strike><?php echo e($value->symbol); ?><?php echo e($value->cost); ?></strike>
                                          <?php echo e($value->symbol); ?><?php echo e($value->offer_cost); ?>
                              ...
                              <?php if (isset($validation['subscription_id'])) { ?>
                                 <label class="error"><?php echo e($validation['subscription_id']); ?></label>
                              <?php } ?>
                           </div>
                        </div>
                     </div>
...
<script type="text/javascript">
   $('#ServiceId').change(function() {
      ...
      if (service_cat_id) {
         $.ajax({
            type: "GET",
            url: "<?php echo e(url('get-servicecategory/')); ?>" + '/' + service_cat_id,
   ...
   $('#home_cat_id').change(function() {
      ...
      if (service_cat_id) {
         $.ajax({
            type: "GET",
            url: "<?php echo e(url('get-service-activity/')); ?>" + '/' + service_cat_id,
            success: function(res) {
               console.log(res);
               if (res) {
                  $("#activity_id").empty();
...
</script><?php /**PATH /home/advent12/public_html/admin/resources/views/admin/adventure_partners/add_adventure_partners.blade.php ENDPATH**/ ?>