            ...
            <div class="col-sm-12">
               <div class="bg-picture text-center" style="background-image:url('<?php echo e(asset('public/assets/images/big/bg.jpg')); ?>')">
                  ...
                  <div class="profile-info-name">
                     <img src="<?php echo e(URL::asset('/public/profile_image/')); ?>/<?php echo e($companydata->profile_image); ?>" class="thumb-lg rounded-circle img-thumbnail" alt="profile-image">
                     <a href="#" onclick="update_profile_image(<?php echo e($companydata->id); ?>)">Edit</a>
                     <h3 class="text-white"><?php echo e($companydata->first_name ?? ''); ?> <?php echo e($companydata->last_name ?? ''); ?></h3>
                  </div>
               </div>
               <!--/ meta -->
            </div>
                        ...
                        <div class="card-body">
                           <form action="<?php echo e('edit-userprofile'); ?>" method="POST" id="FormValidation" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="text" name="name" id="name" value="<?php echo e($companydata->name ?? ''); ?> " id="Name" required="" aria-required="true" class="form-control">
                              </div>
                              <div class="form-group">
                                 <label for="Email">Email</label>
                                 <input type="email" name="email" value="<?php echo e($companydata->email ?? ''); ?> <?php echo e($companydata->last_name ?? ''); ?>" id="Email" class="form-control" required="" aria-required="true" readonly="">
                              </div>
...
<div id="unique-model" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         ...
         <form action="<?php echo e(url('update-user-profile-image')); ?>" method="POST" id="FormValidation" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<script type="text/javascript">
   function update_profile_image(id) {
      ...
      $.ajax({
         url: "<?php echo e(url('update-profile-image/')); ?>" + '/' + id,
         method: "POST",
...
</script><?php /**PATH /home/advent12/public_html/admin/resources/views/admin/user/user-profile.blade.php ENDPATH**/ ?>