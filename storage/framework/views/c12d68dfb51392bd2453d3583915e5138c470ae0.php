...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h4 class="pull-left page-title"><a href="<?php echo e(URL::to('list-admin-users')); ?>">Users </a>  > #<?php echo e($editdata->id); ?></h4>
            </div>
        </div>
                    ...
                    <div class="row">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <h3>
                                        ...
                                        <img src="<?php echo e(asset('public/images').'/'.$editdata->profile_image); ?>" alt="image" width="100" height="100">
                                        <?php else: ?>
                        ...
                        <div class="col-md-6">
                            <ul>
                                ...
                                <li>
                                   <div id="cometchat" class="cometchat"><img src="<?php echo e(asset('/public/images/button_notify.png')); ?>">Notify</div>
                                </li>
                                <li>
                                   <div id="cometchat" class="cometchat"><a href="<?php echo e(URL::to('delete-adminuser',$editdata->id)); ?>" >Delete</a> &nbsp;&nbsp;&nbsp;</div>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<?php /**PATH /home/advent12/public_html/admin/resources/views/admin/admin_users/view_admin_user.blade.php ENDPATH**/ ?>