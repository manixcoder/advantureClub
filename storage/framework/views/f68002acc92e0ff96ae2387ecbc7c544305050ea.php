      ...
      <div class="row">
         <div class="col-sm-12">
            ...
            <ul class="breadcrumb pull-right">
               <li><a href="<?php echo e(URL::to('add-promocodes')); ?>" class="waves-effect"><img src="<?php echo e(asset('/public/images/add_user.png')); ?>">&nbsp;&nbsp;<span>Create Promocode </span></a>
            </ul>
         </div>
      </div>
      <div class="row">
            ...
            <div class="card ">
               <div class="card-body">
                  <table id="datatable-responsive1" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                     ...
                     <tbody>
                        <?php $__currentLoopData = $promocodeData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                          <!-- echo"<pre>";<?php echo e(print_r($data)); ?>;exit;  -->
                        <tr class="gradeX">
                           <td>#<?php echo e($data->id); ?></td>
                           <td><?php echo e($data->promocode_name); ?></td>
                           <td><?php echo e($data->code); ?></td>
                           <td><?php echo e($data->discount_amount); ?></td>
                           <td><?php echo e($data->start_date); ?></td>
                           <td><?php echo e($data->end_date); ?></td>
                           <td><?php echo e($data->redeemed_count); ?></td>
                           <?php 
                              if($data->status == 1){
                                 $status = 'Active';
                                 $class='badge-success';
                           ...
                           <ul class="edit_icon action_icons dashboard_icons">
                              <li>              
                                 ...
                                 <li>
                                    <a href="<?php echo e(URL::to('promocode/delete/'.$data->id)); ?>" onclick="return confirm('Are you sure you want to delete this request ?')" class="bg-red"><i class="fa fa-trash"></i></a>
                                 </li>
                              </ul>
                           </td>
                        </tr>
...
<script>
 $(window).load(function() {
   $('#datatable-responsive1').on("click", ".togBtn", function(){
      ...
      let _token = $('meta[name="csrf-token"]').attr('content');
      $.ajax({   
            url:"<?php echo e(url('update-promo-status')); ?>"+'/'+id,    
            method:"GET",
            contentType : 'application/json',
...
</script><?php /**PATH /home/advent12/public_html/admin/resources/views/admin/promocode/list_promocode.blade.php ENDPATH**/ ?>