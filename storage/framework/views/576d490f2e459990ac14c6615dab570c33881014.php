...
<div class="content add_adventure_users">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h4 class="pull-left page-title"><a href="<?php echo e(URL::to('list-adventure-users')); ?>">Announcement</a> > Add New Announcement</h4>
            </div>
        </div>

        <form action="<?php echo e(URL::to('add-announcements')); ?>" method="POST" id="FormValidation" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php if (isset($validation['licensed'])) { ?>
                                            <label class="error"><?php echo e($validation['licensed']); ?></label>
                                        <?php } ?>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    <?php } ?>
</script><?php /**PATH /home/advent12/public_html/admin/resources/views/admin/transactions/add_announcement.blade.php ENDPATH**/ ?>