...
<div class="content">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-xl-4">
                <a href="<?php echo e(url::to('sub-packages')); ?>">
                    <div class="mini-stat clearfix bg-dark">
                        ...
                        <div class="total_users">
                            <div class="tiles-progress">
                                <p>New Partner</p>
                                <span><?php echo e($new_subscription); ?></span>
                            </div>
                            <div class="mini-stat-info">
                                <p>Total Partner</p>
                                <span class="counter"><?php echo e($total_subscription); ?></span>
                            </div>
                        </div>
                    </div>
                </a>
...
</div><?php /**PATH /home/arknewtech/public_html/adventuresClub/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>