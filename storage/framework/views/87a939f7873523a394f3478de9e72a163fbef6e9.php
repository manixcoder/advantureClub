<div class="content add_adventure_users">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h4 class="pull-left page-title"><a href="<?php echo e(URL::to('services')); ?>">My Services</a> > Create Service</h4>
            </div>
        </div>
        <form action="<?php echo e(URL::to('services/add')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <?php if (isset($validation['owner'])) { ?>
                                            <label class="error"><?php echo e($validation['owner']); ?></label>
                                        <?php } ?>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <?php if (isset($validation['banners'])) { ?>
                                            <label class="error"><?php echo e($validation['banners']); ?></label>
                                        <?php } ?>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        ?>
                                        <input type="text" id="adventure_name" name="adventure_name" class="form-control" value="<?php echo e($adventure_name); ?>" placeholder="Adventure Name">
                                        <?php if (isset($validation['adventure_name'])) { ?>
                                            <label class="error"><?php echo e($validation['adventure_name']); ?></label>
                                        <?php } ?>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php if (isset($validation['service_sector'])) { ?>
                                            <label class="error"><?php echo e($validation['service_sector']); ?></label>
                                        <?php } ?>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php if (isset($validation['service_category'])) { ?>
                                            <label class="error"><?php echo e($validation['service_category']); ?></label>
                                        <?php } ?>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php if (isset($validation['service_type'])) { ?>
                                            <label class="error"><?php echo e($validation['service_type']); ?></label>
                                        <?php } ?>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php if (isset($validation['service_level'])) { ?>
                                            <label class="error"><?php echo e($validation['service_level']); ?></label>
                                        <?php } ?>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        ?>
                                        <input type="text" id="available_seats" name="available_seats" class="form-control" value="<?php echo e($available_seats); ?>" placeholder="Available Seats">
                                        <?php if (isset($validation['available_seats'])) { ?>
                                            <label class="error"><?php echo e($validation['available_seats']); ?></label>
                                        <?php } ?>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php if (isset($validation['activities'])) { ?>
                                            <label class="error"><?php echo e($validation['activities']); ?></label>
                                        <?php } ?>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        ?>
                                        <textarea class="form-control" id="write_information" name='write_information' rows="7" placeholder="Write information"><?php echo e($write_information); ?></textarea>
                                        <?php if (isset($validation['write_information'])) { ?>
                                            <label class="error"><?php echo e($validation['write_information']); ?></label>
                                        <?php } ?>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <?php if (isset($validation['recommended'])) { ?>
                                                    <label class="error"><?php echo e($validation['recommended']); ?></label>
                                                <?php } ?>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            ?>
                                                <div class="col-md-4">
                                                    <input type="radio" name="service_plan" class="service_plan_radio" id="service_plan1" value="<?php echo e($splan->id); ?>" <?= $checked ?>>
                                                    <?php echo e($splan->title); ?>

                                                </div>
                                            <?php } ?>
                                            <div class="col-md-12">
                                                <?php if (isset($validation['service_plan'])) { ?>
                                                    <label class="error"><?php echo e($validation['service_plan']); ?></label>
                                                <?php } ?>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12 inline-checkboxes">
                                                ...
                                                ?>
                                                    <div class="checkbox-cus">
                                                        <input type="checkbox" name='service_plan_days[]' value="<?php echo e($wd->id); ?>" <?= $checked ?>>
                                                        <?php echo e($wd->day); ?>
                                        ...
                                        <div class="row calender_days_div" style="display:none">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    ?>
                                                    <input type="text" id="start_date" name="start_date" class="form-control datepicker" value="<?php echo e($start_date); ?>" placeholder="Start date" readonly>
                                                    <?php if (isset($validation['start_date'])) { ?>
                                                        <label class="error"><?php echo e($validation['start_date']); ?></label>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    ?>
                                                    <input type="text" id="end_date" name="end_date" class="form-control datepicker" value="<?php echo e($end_date); ?>" placeholder="End date" readonly>
                                                    <?php if (isset($validation['end_date'])) { ?>
                                                        <label class="error"><?php echo e($validation['end_date']); ?></label>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                        ...
                                        <?php if (isset($validation['service_plan_days'])) { ?>
                                            <label class="error"><?php echo e($validation['service_plan_days']); ?></label>
                                        <?php } elseif (isset($validation['particular_date'])) { ?>
                                            <label class="error"><?php echo e($validation['particular_date']); ?></label>
                                        <?php }
                                        ?>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row weekdays-row">
                                            <div class="col-md-12 inline-checkboxes">
                                                ...
                                                ?>
                                                    <div class="checkbox-cus">
                                                        <input type="checkbox" name='service_for[]' value='<?php echo e($sfor->id); ?>' <?= $checked ?>>
                                                        <?php echo e($sfor->sfor); ?>
                                        ...
                                        <?php if (isset($validation['service_for'])) { ?>
                                            <label class="error"><?php echo e($validation['service_for']); ?></label>
                                        <?php } ?>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="row weekdays-row">
                                            <div class="col-md-12 inline-checkboxes">
                                                ...
                                                ?>
                                                    <div class="checkbox-cus">
                                                        <input type="checkbox" name="dependency[]" value="<?php echo e($dep->id); ?>" <?= $checked ?>>
                                                        <?php echo e($dep->dependency_name); ?>
                                        ...
                                        <?php if (isset($validation['dependency'])) { ?>
                                            <label class="error"><?php echo e($validation['dependency']); ?></label>
                                        <?php } ?>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                        ...
                                        ?>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                ...
                                                                ?>
                                                                <input type="text" class="form-control" id="schedule_title" name='schedule_title[]' placeholder="Schedule Title" value="<?php echo e($s_title); ?>">
                                                                <?php if (isset($validation['schedule_title'])) { ?>
                                                                    <label class="error"><?php echo e($validation['schedule_title']); ?></label>
                                                                <?php } ?>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <input type="text" class="form-control cursor-pointer gathering_datepicker" name='gathering_date[]' placeholder="Gathering Date" value="<?php echo e($g_date); ?>" readonly>
                                                                <?php if (isset($validation['gathering_date'])) { ?>
                                                                    <label class="error"><?php echo e($validation['gathering_date']); ?></label>
                                                                <?php } ?>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <input type="text" class="form-control cursor-pointer gathering_start_time" name='gathering_start_time[]' placeholder="Start Time" value="<?php echo e($g_stime); ?>" readonly>
                                                                <?php if (isset($validation['gathering_start_time'])) { ?>
                                                                    <label class="error"><?php echo e($validation['gathering_start_time']); ?></label>
                                                                <?php } ?>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <input type="text" class="form-control cursor-pointer gathering_end_time" name='gathering_end_time[]' placeholder="End Time" value="<?php echo e($g_etime); ?>" readonly>
                                                                <?php if (isset($validation['gathering_end_time'])) { ?>
                                                                    <label class="error"><?php echo e($validation['gathering_end_time']); ?></label>
                                                                <?php } ?>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        ?>
                                                        <textarea class="form-control" rows="7" id='program_description' name='program_description[]' placeholder="Program description"><?php echo e($p_desc); ?></textarea>
                                                        <?php if (isset($validation['program_description'])) { ?>
                                                            <label class="error"><?php echo e($validation['program_description']); ?></label>
                                                        <?php } ?>
                                                    </div>
                                                </div> <?php
                                                    }
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                ?>
                                                <input type="text" class="form-control" id="specific_address" name='specific_address' placeholder="Type Specific Address/Location" value="<?php echo e($specific_address); ?>">
                                                <?php if (isset($validation['specific_address'])) { ?>
                                                    <label class="error"><?php echo e($validation['specific_address']); ?></label>
                                                <?php } ?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            ?>
                                            <input type="text" class="form-control" id="cost_inc" name='cost_inc' placeholder="Set Cost" value="<?php echo e($cost_inc); ?>">
                                            <small>Including gears and other taxes</small>
                                            <?php if (isset($validation['cost_inc'])) { ?>
                                                <label class="error"><?php echo e($validation['cost_inc']); ?></label>
                                            <?php } ?>
                                        </div>
                                        <div class="col-md-4">
                                            <?php
                                            ...
                                            ?>
                                            <input type="text" class="form-control" id="cost_exc" name='cost_exc' placeholder="Set Cost" value="<?php echo e($cost_exc); ?>">
                                            <small>Excluding gears and other taxes</small>
                                            <?php if (isset($validation['cost_exc'])) { ?>
                                                <label class="error"><?php echo e($validation['cost_exc']); ?></label>
                                            <?php } ?>
                                        </div>
                                        <div class="col-md-4">
                                            <?php
                                            ...
                                            <select class="form-control" id="currency" name='currency'>
                                                ...
                                                ?>
                                                    <option value="<?php echo e(@$curr['id']); ?>" <?= $sel ?>><?php echo @$curr['currency'] . ' (' . @$curr['country'] . ')'; ?></option>
                                                <?php } ?>
                                            </select>
                                            <?php if (isset($validation['currency'])) { ?>
                                                <label class="error"><?php echo e($validation['currency']); ?></label>
                                            <?php } ?>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    ?>
                                    <textarea class="form-control" rows="7" id='pre_requisites' name='pre_requisites' placeholder="Type Pre-Requisites..."><?php echo e($pre_requisites); ?></textarea>
                                    <?php if (isset($validation['pre_requisites'])) { ?>
                                        <label class="error"><?php echo e($validation['pre_requisites']); ?></label>
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    ?>
                                    <textarea class="form-control" rows="7" id='minimum_requirements' name='minimum_requirements' placeholder="Type Minimum Requirement..."><?php echo e($minimum_requirements); ?></textarea>
                                    <?php if (isset($validation['minimum_requirements'])) { ?>
                                        <label class="error"><?php echo e($validation['minimum_requirements']); ?></label>
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    ?>
                                    <textarea class="form-control" rows="7" id="terms_conditions" name='terms_conditions' placeholder="Type Terms & Conditions..."><?php echo e($terms_conditions); ?></textarea>
                                    <?php if (isset($validation['terms_conditions'])) { ?>
                                        <label class="error"><?php echo e($validation['terms_conditions']); ?></label>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    <?php } ?>
</script><?php /**PATH /home/advent12/public_html/admin/resources/views/admin/services/update_services.blade.php ENDPATH**/ ?>