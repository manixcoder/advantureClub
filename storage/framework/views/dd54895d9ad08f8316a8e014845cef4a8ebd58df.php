                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        ?>
                                        <input type="text" id="name" name="name" class="form-control" aria-required="true" value="<?php echo e($name); ?>" placeholder="User Name" onkeypress="return /[0-9a-zA-Z]/i.test(event.key)">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php if (isset($validation['cities'])) { ?>
                                            <label class="error"><?php echo e($validation['cities']); ?></label>
                                        <?php } ?>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="mobile_code" name="mobile_code">
                                                    ...
                                                    ?>
                                                        <option value="<?php echo e($value->code); ?>" <?php echo $sel; ?>><?php echo e($value->code.' - '.$value->country); ?></option>
                                                    <?php } ?>
                                                </select>
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                ...
                                                ?>
                                                <input type="text" id="mobile" name="mobile" class="form-control" value="<?php echo e($mobile); ?>" aria-required="true" placeholder="Mobile Number" minlength="5">
                                                <!-- <input type="text" id="mobile" name="mobile" class="form-control" value="<?php echo e($mobile); ?>" aria-required="true" placeholder="Mobile Number" maxlength="15" required oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"> -->
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="weight" id="weight" class="form-control" aria-required="true">
                                            ...
                                            <option value="<?php echo e($weight->weightName); ?>"><?php echo e($weight->weightName); ?></option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="height" id="height" class="form-control" aria-required="true">
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $heights; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $height): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <option value="<?php echo e($height->heightName); ?>"><?php echo e($height->heightName); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                            <p>No Record</p>
                                            <?php endif; ?>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php if (isset($validation['gender'])) { ?>
                                            <label class="error"><?php echo e($validation['gender']); ?></label>
                                        <?php } ?>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php if (isset($validation['password'])) { ?>
                                            <label class="error"><?php echo e($validation['password']); ?></label>
                                        <?php } ?>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="natinality" name="natinality">
                                            ...
                                            ?>
                                                <option value="<?php echo e($value->id); ?>" <?php echo $sel; ?>><?php echo e($value->short_name); ?></option>
                                            <?php } ?>
                                        </select>
                                        <?php if (isset($validation['natinality'])) { ?>
                                            <label class="error"><?php echo e($validation['natinality']); ?></label>
                                        <?php } ?>
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            ?>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <span for="chk_1"><?php echo e($hel->name); ?></span>
                                        </div>
                                    </div>
                            <?php
                                }
...
<script type="text/javascript">
    ...
    <?php } ?>
</script><?php /**PATH /home/advent12/public_html/admin/resources/views/admin/adventure_users/add_adventure_users.blade.php ENDPATH**/ ?>